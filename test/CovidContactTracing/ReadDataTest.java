...
import static CovidContactTracing.ReadData.readPersonFile;
...
class ReadDataTest {
    ...
    @Test
    void ReadPersonFile_Test() {

        final Person[] per = readPersonFile("Resources/ContactListTestData1");
        final Person pTest = new Person("Max", "Mustermann", 46, 'm', new Address(3100, "St. Pölten", "NOE", "Waldstrasse7"), 1, new Position(0, 0), true);
        assertEquals(equals(per[0],pTest),true);
